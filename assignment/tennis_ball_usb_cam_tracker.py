...
def image_callback(new_image):
  ...
  try:
     rgb1_image = CvBridge().imgmsg_to_cv2(new_image,"bgr8")
  except CvBridgeError as e:
      print(e)

  #cv2.imshow("Image window", rgb1_image)
  cv2.waitKey(1)
  ball_detection(rgb1_image)
...
def draw_ball_contour(binary_image, rgb_image, contours):
    ...
    for c in contours:
        ...
        if (area>3000):
            ...
            cv2.circle(black_image, (cx,cy),(int)(radius),(0,0,255),3)
...
def main():
    rospy.init_node('tennis_ball_usb_cam_subscriber',anonymous=True)
